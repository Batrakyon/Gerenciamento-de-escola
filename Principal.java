	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		while(opcao != 6) {
			...
			case 1:
				...
				while (gereciamento_aluno != 5){ //menu alunos

					System.out.println("\n-------------------------------");
					System.out.println("1 - Adicionar Aluno; ");
					System.out.println("2 - Registrar Aluno em Turma; ");
					System.out.println("3 - Modificar informações de Aluno; ");
					...
					case 2:
						...
						// colocar a condição de exiostencia da turma aqui
			...
			case 2:
				...
				while (gereciamento_docente != 5){ //menu docentes
					...
					case 2:
						...
						// colocar a condição de exiostencia da disciplina aqui
